...
import { RiMailLine, RiFocus3Line, RiUploadLine, RiBuilding3Line, RiCalendar2Line, RiMoneyDollarCircleLine } from "react-icons/ri"
        ...
        <div>
            ...
            <div style={{display: "flex", justifyContent: "center"}}>
                <div style={{display: "flex", alignItems: "center", justifyContent: "space-between", width: "80vw",}}>
                    ...
                    <ApplyButton><RiMailLine style={{width: "20px", height: "20px"}}/>APPLY NOW</ApplyButton>
                </div>
            </div>
            <section style={{display: "flex", flexDirection: "column", alignItems: "center"}}>
                ...
                <div style={{width: "800px", marginTop: "30px"}}>
                    ...
                    <FileButton><RiUploadLine/>Choosen File</FileButton>
                    <input type="file" style={{display: "none"}}/>
                    <JobCreateDate style={{marginTop: "10px"}}>Only PDF. Max size 5MB</JobCreateDate>
                    <JobCreateDate style={{marginBottom: "5px", marginTop: "10px"}}>Professional experience (taken from your profile)</JobCreateDate>
                    ...
                    <JobCreateDate style={{marginBottom: "5px", marginTop: "10px"}}>Why are you interested in working at The company name SA</JobCreateDate>
                    <input type="text" style={{
                        width: "744px",
                        border: "1px solid #F48FB1",
                        outline: "none",
                    ...
                    <JobCreateDate>Between 50 and 1000 characters</JobCreateDate>
                    <ApplyButton style={{marginTop: "10px", width: "233px",}}><RiMailLine style={{width: "20px", height: "20px"}}/>SEND APPLICATION</ApplyButton>
                </div>
            </section>
        </div>
    )
