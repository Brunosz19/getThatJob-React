...
export default function YourApplications(){
    ...
    return (
        <div>
            ...
            <div>
                <ApplicationFilterTitle>FILTER YOUR APPLICATIONS</ApplicationFilterTitle>
                <ApplicationFilterConteiner>
                    ...
                    <input type="checkbox"/>
                    <ApplicationText style={{color: "#616161"}}>Declined</ApplicationText>
                </ApplicationFilterConteiner>
                <ApplicationsFound style={{marginTop: "16px"}}>4 applications found</ApplicationsFound>
                <div style={{marginTop: "8px", marginBottom: "16px", boxShadow: "0px 2px 8px rgba(0, 0, 0, 0.2)", border: "1px solid #E1E2E1", borderRadius: "8px"}}>
                    <div style={{display: "flex",  justifyContent: "space-between", height: "100%", widht: "100%", alignItems: "center", padding: "5px 10px"}}>
                        ...
                        <div style={{display: "flex", flexDirection: "column", alignItems: "center",}}>
                            ...
                            <div style={{display: "flex", width: "200px",}}>
                                <ApplicationsmmLetter style={{marginRight: "10px"}}>2.0k - 2.5k</ApplicationsmmLetter>
                                <ApplicationsmmLetter>Posted 2 days ago</ApplicationsmmLetter>
                            </div>
                        </div>
                        <div style={{display: "flex"}}>
                            <ApplicationsmmLetter style={{width: "80px", textAlign: "center"}}>Send 1 min ago</ApplicationsmmLetter>
                            <ApplicationsmmLetter style={{width: "80px", textAlign: "center"}}>Waiting for review</ApplicationsmmLetter>
                    ...
                    <div style={{padding: "5px 10px", display: `${(detailsOpen === "hola") ? "flex" : "none"}`, flexDirection: "column"}}>
                        <ApplicationFilterConteiner>Last Updated on 03/22/21</ApplicationFilterConteiner>
                        ...
                        <ApplicationText>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas egestas ex at libero feugiat volutpat. Praesent fringilla scelerisque felis, ac elementum metus fringilla in. Maecenas et nibh fringilla, egestas arcu vel, tristique dui. Nulla quis suscipit erat, nec pretium arcu. Aenean blandit lacinia mauris, quis bibendum ante sagittis cursus. Pellentesque mattis ipsum et lorem euismod rutrum. Duis ullamcorper venenatis nisi, nec malesuada tellus tincidunt a. Maecenas suscipit odio sed justo accumsan iaculis. Quisque vitae erat ac felis tincidunt auctor vitae non est. Praesent vehicula feugiat faucibus.</ApplicationText>
